...
static void md5_process(mir_md5_state_t *pms, const mir_md5_byte_t *data)
{
	mir_md5_word_t
...
void MMD5Interface::md5_init(mir_md5_state_t *pms)
{
...
void MMD5Interface::md5_append(mir_md5_state_t *pms, const mir_md5_byte_t *data, int nbytes)
{
...
void MMD5Interface::md5_finish(mir_md5_state_t *pms, mir_md5_byte_t digest[16])
{
